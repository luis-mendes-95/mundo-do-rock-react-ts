...
const FormDeleteSale = () => {
  ...
  const { set_modal_delete_sale ,dataDelete, deleteSale } = useContext(SalesContext)
  ...
  return (
    <div style={{width:"100%", display:"flex", justifyContent:"center", flexDirection:"column", textAlign:"center", alignItems:"center", gap:"5px", fontWeight:"bold"}}>
      ...
      <main.Button_delete style={{width:"50%"}} onClick={()=>{set_modal_delete_sale(dataDelete)}}>Cancelar</main.Button_delete>
    </div>
  )
}
